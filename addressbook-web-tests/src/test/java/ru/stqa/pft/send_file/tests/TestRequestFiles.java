...
public class TestRequestFiles extends TestBase {
    ...
    public void test_create_request_link_and_validate_link() {
        ...
        String request_link = "https://" + app.requestFile_page.get_request_link();
    ...
    @Test
    public void test_create_request_link_and_send_file_by_request() {
        ...
        app.sendFile_page.fill_in_send_by_request_form("Autotest", "Autotest test test");
